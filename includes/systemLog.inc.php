...
if(isset($_POST["action"]))
{
	...
	{
		$order_column = array('username', 'email', 'time');

		$main_query = "
		SELECT  `username`, `email`, `time`
		FROM users_log
		";
		...
		{
			$search_query .= 'WHERE (username LIKE "%'.$_POST["search"]["value"].'%" OR email LIKE "%'.$_POST["search"]["value"].'%" OR time LIKE "%'.$_POST["search"]["value"].'%")';
		}
